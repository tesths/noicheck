...
class Config:
    ...
    JOB_QUEUE_PUBLISH_MAX_ATTEMPTS = max(int(os.getenv("JOB_QUEUE_PUBLISH_MAX_ATTEMPTS", "2")), 1)
    JOB_QUEUE_PUBLISH_RETRY_BACKOFF_SECONDS = max(
        float(os.getenv("JOB_QUEUE_PUBLISH_RETRY_BACKOFF_SECONDS", "0.2")),
        0.0,
    )
